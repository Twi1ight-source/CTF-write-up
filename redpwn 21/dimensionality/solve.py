...
inp=[Int(f'inp_{i}')for i in range(28)]
a3=0x54
...
for i in range(28):
    a3+=If(inp[i]==ord('b'),fun_b(), If(inp[i]==ord('d'),fun_d(), If(inp[i]==ord('f'),fun_f(), If(inp[i]==ord('l'),fun_l(), If(inp[i]==ord('r'),fun_r(), If(inp[i]==ord('u'),fun_u(), fun()))))))
